...
public class StringMethods {
	 ...
	 public static void main(String[] args) {
	    ...
	    */  
		...
		/*
		substring (beginning index): it creates sub value og the String from 
		begining index till the last index and
		...
		String Address ="Iowa IA 52240 ";
		//               0123456789...
		String zipcode = Address.substring(8);
		System.out.println(zipcode);
		
		/*
		  substring (beginning index, ending index):
		  it creates sub value of the string from
		   the beginning index till ending index
		...
		//            0123456789............
		Name = Name.substring(6, 14); // "Cyberte" 13 is excluded no K at the end
		                              // 13+1 or 14 
